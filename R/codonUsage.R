...
codonUsage <- function(ads,
  ...
  for(j in 1:length(comparisons)){
    ...
    #
      ...
      plot(finalOut$statOut,finalOut$freq,col='black',pch=20,cex=0.1,xlab='',ylab='',lwd=1,bty="n",xaxt="n",yaxt="n",font=2,xlim=c(0,ceiling(range(finalOut$statOut)[2])),ylim=range(finalOut$freq))

...
These inputs are compiled at the start of the analysis by initializing a `postNetData` object. This class of object serves as the container for storing inputs and some outputs generated during the analysis, and is designated by `ptn` in the example code provided here.  

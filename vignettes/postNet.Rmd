...
The example below will compute a list (`GC_content`) of the percentage of GC content for each gene and sequence region, and produce three PDF files with violin plots and statistics comparing the length of each sequence region between gene sets and background.   
...
Smaller values of Gibbs free energy (Δ*G*) indicate more stable structures, while larger values indicate less stable, more flexible mRNA molecules. 

...
```{r load_package_data, eval=FALSE, echo=TRUE} 
# Load the package 
library(postNet)
...
```{r gettingStartedInput, eval=FALSE, echo=TRUE}
...
```{r gettingStartedInitialize, eval=FALSE, echo=TRUE, results='hide'}
...
```{r gettingStartedEnumerate, eval=FALSE, echo=TRUE}
...
```{r gettingStartedEnumeratePNGS, echo=FALSE, fig.cap="Comparisons of 5'UTR length and GC content between mRNAs belonging to regulated gene sets."}
...
```{r gettingStartedPlotFeaturesMap, eval=FALSE, echo=TRUE}
...
```{r postNetStartGeneList, eval=FALSE, echo=TRUE}
...
```{r postNetStartGeneListInit, eval=FALSE, echo=TRUE, results = 'hide'}
...
```{r GetAds, eval=FALSE, echo=TRUE, results = 'hide', warning = FALSE}
...
```{r postNetStartAds, eval=FALSE, echo=TRUE, results = 'hide'}
...
```{r lengthAnalysisBoxplot, eval=FALSE, echo=TRUE}
...
```{r contentAnalysisGCviolin, eval=FALSE, echo=TRUE}
...
```{r foldingEnergyBoxplot, eval=FALSE, echo=TRUE}
...
```{r uorfAnalysis, eval=FALSE, echo=TRUE}
...
```{r contentMotifs, eval=FALSE, echo=TRUE}
...
```{r signCalc, eval=FALSE, echo=TRUE}
...
```{r slopeFilt, eval=FALSE, echo=TRUE}
...
```{r plotSignatures, eval=FALSE, echo=TRUE, message = FALSE, results = 'hide'}
...
```{r plotSignaturesAds, eval=FALSE, echo=TRUE, results='hide', warning = FALSE}
...
```{r plotSignaturesHeatmap, eval=FALSE, echo=TRUE, results='hide'}
...
```{r plotSignaturesHeatmapPNG, eval=FALSE, echo=FALSE, fig.wide = TRUE, fig.cap="A heatmap of -log10(FDRs) for regulation of various gene signatures in the example dataset. Colours indicate the directionality of regulation."}

...
A postNet analysis can consists of the following steps: 
...
```{r gettingStartedenumeratePNGS, echo=FALSE, fig.align="center", fig.height=20, fig.width=20, out.width="120%", fig.cap="Comparisons of 5'UTR length and GC content between mRNA belonging to regulated gene sets."}
...
# Prepare the list of features to be used in modelling 
features <- postNetExample$features
str(features)

# Group the features according to category (optional)
lmfeatGroup = c("UTR5", "UTR3", rep("UTR5",3), rep("UTR3",4), "CDS", "CDS", "UTR5", "UTR5", rep("Pathway",2),"UTR5", rep("Pathway",2))
lmfeatGroupColour = c('#534b62','#6699cc','#e9724c','#fff275')
names(lmfeatGroupColour) <- c("UTR5","CDS", "UTR3","Pathway")
...
```{r gettingStartedFeatureIntHidePlots, echo = FALSE, message = FALSE, results = 'hide', eval = TRUE}
unlink(c("Example_UTR5_boxplot_lengthAnalysis.pdf", "Example_UTR5_GC_content.pdf","Figures/Example_UTR5_boxplot_lengthAnalysis.png","Figures/Example_UTR5_GC_content.png"))
```

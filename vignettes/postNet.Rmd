...
magick::image_read_pdf("Example_UTR5_boxplot_lengthAnalysis.pdf", density = 300) %>%
  ...
  magick::image_write("vignettes/Figures/Example_UTR5_boxplot_lengthAnalysis.png")

magick::image_read_pdf("Example_UTR5_GC_content.pdf", density = 300) %>%
  magick::image_resize("3000x") %>%
  magick::image_write("vignettes/Figures/Example_UTR5_GC_content.png")

# Read each image
img1 <- magick::image_read("vignettes/Figures/Example_UTR5_boxplot_lengthAnalysis.png")
img2 <- magick::image_read("vignettes/Figures/Example_UTR5_GC_content.png")

# Append them horizontally
combined <- magick::image_append(c(img1, img2), stack = FALSE)

# Save combined image at high resolution
magick::image_write(combined, path = "vignettes/Figures/combined_UTR5_features.png")
...
knitr::include_graphics("vignettes/Figures/combined_UTR5_features.png")

```

```{r gettingStartedhidePlots, echo = FALSE, message = FALSE, results = 'hide', eval = TRUE}
unlink(c("Example_UTR5_boxplot_lengthAnalysis.pdf", "Example_UTR5_GC_content.pdf","vignettes/Figures/Example_UTR5_boxplot_lengthAnalysis.png","vignettes/Figures/Example_UTR5_GC_content.png"))
```

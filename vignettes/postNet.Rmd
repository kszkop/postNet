...
# Examine the regulation of mTOR-sensitive transcripts in the results of the anota2seq analysis 
 plotSignatures(ptn = ptn,
                               signatureList = humanSignatures[c('Gandin_etal_2016_mTOR_transUp','Gandin_etal_2016_mTOR_transDown')],
...
```{r plotSignaturesPNG, echo=FALSE, fig.wide = TRUE, fig.cap="A plot visualizing GSEA results for the enrichment of the gene Set1 in the example dataset."}
knitr::include_graphics("Figures/mTORsignatures.pdf")

```

```{r plotSignaturesHide, echo = FALSE, message = FALSE, results = 'hide', eval = TRUE}

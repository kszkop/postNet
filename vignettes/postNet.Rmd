...
In the example below, enriched and depleted codons will be identified between translationally activated and suppressed gene sets using. These are defined as those with and adjusted p-value less than 0.01 in a Chi-square test, and are within the top 30\% or enrichment or depletion based on odds ratios and average frequencies.  

...
knitr::opts_chunk$set(tidy = FALSE,
                      cache = FALSE,
                      fig.path = "vignettes/figures_temp/",
                      dev = "png",
                      message = FALSE, 
                      error = FALSE, 
                      warning = TRUE)
...
# Convert to PNG
magick::image_read_pdf("Example_UTR5_boxplot_lengthAnalysis.pdf", density = 300) %>%
  magick::image_resize("3000x") %>%
  magick::image_write("Example_UTR5_boxplot_lengthAnalysis.png")

magick::image_read_pdf("Example_UTR5_GC_content.pdf", density = 300) %>%
  magick::image_resize("3000x") %>%
  magick::image_write("Example_UTR5_GC_content.png")

# Read each image
img1 <- magick::image_read("Example_UTR5_boxplot_lengthAnalysis.png")
img2 <- magick::image_read("Example_UTR5_GC_content.png")

# Append them horizontally
combined <- magick::image_append(c(img1, img2), stack = FALSE)

# Save combined image at high resolution
magick::image_write(combined, path = "combined_UTR5_features.png")
...
knitr::include_graphics("combined_UTR5_features.png")

```

```{r gettingStartedhidePlots, echo = FALSE, message = FALSE, results = 'hide', eval = TRUE}
unlink(c("Example_UTR5_boxplot_lengthAnalysis.pdf", "Example_UTR5_GC_content.pdf","Example_UTR5_boxplot_lengthAnalysis.png","Example_UTR5_GC_content.png"))
```
...
image_read_pdf("omnibus_lm_translationUp_translationDown_network.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("omnibus_lm_translationUp_translationDown_network.png")

image_read_pdf("omnibus_lm_translationUp_translationDown_UTR5_SCSCGS_individually.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("omnibus_lm_translationUp_translationDown_UTR5_SCSCGS_individually.png")
...
knitr::include_graphics("omnibus_lm_translationUp_translationDown_network.png")
...
image_read_pdf("Example_UTR5_SCSCGS_featureUMAP.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR5_SCSCGS_featureUMAP.png")
...
knitr::include_graphics("Example_UTR5_SCSCGS_featureUMAP.png")
...
image_read_pdf("Example_UTR5_ecdf_lengthAnalysis.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR5_ecdf_lengthAnalysis.png")

image_read_pdf("Example_UTR3_ecdf_lengthAnalysis.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR3_ecdf_lengthAnalysis.png")

image_read_pdf("Example_CDS_ecdf_lengthAnalysis.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_CDS_ecdf_lengthAnalysis.png")

# Read each image
img1 <- image_read("Example_UTR5_ecdf_lengthAnalysis.png")
img2 <- image_read("Example_UTR3_ecdf_lengthAnalysis.png")
img3 <- image_read("Example_CDS_ecdf_lengthAnalysis.png")

# Append them horizontally
combined <- image_append(c(img1, img2, img3), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_length.png")
...
knitr::include_graphics("combined_length.png")
...
unlink(c("Example_UTR5_ecdf_lengthAnalysis.pdf", "Example_UTR3_ecdf_lengthAnalysis.pdf", "Example_CDS_ecdf_lengthAnalysis.pdf",
         "Example_UTR5_ecdf_lengthAnalysis.png", "Example_UTR3_ecdf_lengthAnalysis.png",
         "Example_CDS_ecdf_lengthAnalysis.png"))
```
...
image_read_pdf("Example_UTR5_GC_content.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR5_GC_content.png")

image_read_pdf("Example_UTR3_GC_content.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR3_GC_content.png")

image_read_pdf("Example_CDS_GC_content.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_CDS_GC_content.png")

# Read each image
img1 <- image_read("Example_UTR5_GC_content.png")
img2 <- image_read("Example_UTR3_GC_content.png")
img3 <- image_read("Example_CDS_GC_content.png")

# Append them horizontally
combined <- image_append(c(img1, img2, img3), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_GC.png")
...
knitr::include_graphics("combined_GC.png")
...
unlink(c("Example_UTR5_GC_content.pdf", "Example_UTR3_GC_content.pdf", "Example_CDS_GC_content.pdf",
         "Example_UTR5_GC_content.png", "Example_UTR3_GC_content.png",
         "Example_CDS_GC_content.png"))
```
...
image_read_pdf("Example_UTR5_boxplot_foldEnergyAnalysis.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR5_boxplot_foldEnergyAnalysis.png")
...
knitr::include_graphics("Example_UTR5_boxplot_foldEnergyAnalysis.png")
...
image_read_pdf("Example_uORFs_strong.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_uORFs_strong.png")
...
knitr::include_graphics("Example_uORFs_strong.png")
...
image_read_pdf("Example_UTR5_SCSCGS_content.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR5_SCSCGS_content.png")
...
knitr::include_graphics("Example_UTR5_SCSCGS_content.png")
...
image_read_pdf("codon_translationUp_translationDown_codonUsage.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codon_translationUp_translationDown_codonUsage.png")

image_read_pdf("codon_translationUp_translationDown_averageFreq.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codon_translationUp_translationDown_averageFreq.png")

# Read each image
img1 <- image_read("codon_translationUp_translationDown_codonUsage.png")
img2 <- image_read("codon_translationUp_translationDown_averageFreq.png")

# Append them horizontally
combined <- image_append(c(img1, img2), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_codon_plots.png")
...
knitr::include_graphics("combined_codon_plots.png")
...
unlink(c("codon_translationUp_translationDown_codonUsage.pdf", "codon_translationUp_translationDown_averageFreq.pdf",
         "codon_translationUp_translationDown_codonUsage.png", "codon_translationUp_translationDown_averageFreq.png"))
```
...
image_read_pdf("codonCAI_index.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codonCAI_index.png")

image_read_pdf("codonCBI_index.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codonCBI_index.png")

image_read_pdf("codonFop_index.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codonFop_index.png")

# Read each image
img1 <- image_read("codonCAI_index.png")
img2 <- image_read("codonCBI_index.png")
img3 <- image_read("codonFop_index.png")

# Append them horizontally
combined <- image_append(c(img1, img2, img3), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_indexes.png")
...
knitr::include_graphics("combined_indexes.png")
...
unlink(c("codonCAI_index.pdf", "codonCBI_index.pdf", "codonFop_index.pdf","codonL_aa_index.pdf","codontAI_index.pdf",
         "codonCAI_index.png", "codonCBI_index.png","codonFop_index.png"))
```
...
image_read_pdf("codon_translationUp_translationDown_heatmap.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codon_translationUp_translationDown_heatmap.png")

image_read_pdf("codontranslationUp_translationDowncodon_oddratio_vs_freq.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("codontranslationUp_translationDowncodon_oddratio_vs_freq.png")

# Read each image
img1 <- image_read("codon_translationUp_translationDown_heatmap.png")
img2 <- image_read("codontranslationUp_translationDowncodon_oddratio_vs_freq.png")

# Append them horizontally
combined <- image_append(c(img1, img2), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_codonSelection.png")
...
knitr::include_graphics("combined_codonSelection.png")
...
unlink(c("codon_translationUp_translationDown_heatmap.pdf", "codontranslationUp_translationDowncodon_oddratio_vs_freq.pdf",
         "codon_translationUp_translationDown_heatmap.png", "codontranslationUp_translationDowncodon_oddratio_vs_freq.png"))
```
...
image_read_pdf("features_Down_codonCalc.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("features_Down_codonCalc.png")

image_read_pdf("features_Up_codonCalc.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("features_Up_codonCalc.png")

# Read each image
img1 <- image_read("features_Up_codonCalc.png")
img2 <- image_read("features_Down_codonCalc.png")

# Append them horizontally
combined <- image_append(c(img1, img2), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_codonCalc.png")
...
knitr::include_graphics("combined_codonCalc.png")
...
unlink(c("features_Down_codonCalc.pdf", "features_Up_codonCalc.pdf",
         "features_Down_codonCalc.png", "features_Up_codonCalc.png"))
```
...
knitr::include_graphics("univariate_models.png")
```
...
knitr::include_graphics("stepwise_regression.png")
```
...
knitr::include_graphics("omnibus_model.png")
```
...
knitr::include_graphics("correlations_model.png")
```
...
image_read_pdf("Example_lm_translationUp_translationDown_network.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_lm_translationUp_translationDown_network.png")
...
knitr::include_graphics("Example_lm_translationUp_translationDown_network.png")
...
image_read_pdf("Example_grouped_lm_translationUp_translationDown_network.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_grouped_lm_translationUp_translationDown_network.png")
...
knitr::include_graphics("Example_grouped_lm_translationUp_translationDown_network.png")
...
image_read_pdf("Example_randomForest_translationUp_translationDown_featureImportance.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_randomForest_translationUp_translationDown_featureImportance.png")
...
knitr::include_graphics("Example_randomForest_translationUp_translationDown_featureImportance.png")
...
image_read_pdf("Example_randomForest_translationUp_translationDown_FinalModel.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_randomForest_translationUp_translationDown_FinalModel.png")
...
knitr::include_graphics("Example_randomForest_translationUp_translationDown_FinalModel.png")
...
image_read_pdf("Example_randomForest_translationUp_translationDown_UTR5_GC_individually.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_randomForest_translationUp_translationDown_UTR5_GC_individually.png")

image_read_pdf("Example_randomForest_translationUp_translationDown_UTR5_SCSCGS_individually.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_randomForest_translationUp_translationDown_UTR5_SCSCGS_individually.png")
...
image_read_pdf("Example_randomForest_translationUp_translationDown_Gandin_etal_2016_mTOR_transUp_individually.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_randomForest_translationUp_translationDown_Gandin_etal_2016_mTOR_transUp_individually.png")

# Read each image
img1 <- image_read("Example_randomForest_translationUp_translationDown_UTR5_GC_individually.png")
img2 <- image_read("Example_randomForest_translationUp_translationDown_UTR5_SCSCGS_individually.png")
img3 <- image_read("Example_randomForest_translationUp_translationDown_Gandin_etal_2016_mTOR_transUp_individually.png")

# Append them horizontally
combined <- image_append(c(img1, img2, img3), stack = FALSE)

# Save combined image at high resolution
image_write(combined, path = "combined_individual.png")
...
knitr::include_graphics("combined_individual.png")
...
knitr::include_graphics("Example_rocr.png")
...
image_read_pdf("Example_UTR5_GC_featureUMAP.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_UTR5_GC_featureUMAP.png")
...
knitr::include_graphics("Example_UTR5_GC_featureUMAP.png")
...
knitr::include_graphics("gsea_Set1.png")
...
image_read_pdf("Example_pooled_GOdotplot_BP.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_pooled_GOdotplot_BP.png")
...
knitr::include_graphics("Example_pooled_GOdotplot_BP.png")
...
image_read_pdf("mTORsignatures_data_Example_signature_mTOR_sensitive_translation.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("mTORsignatures_data_Example_signature_mTOR_sensitive_translation.png")
...
knitr::include_graphics("mTORsignatures_data_Example_signature_mTOR_sensitive_translation.png")

```

```{r plotSignaturesHide, eval = TRUE, echo = FALSE, message = FALSE, results = 'hide'}
...
image_read_pdf("Example_ISRsignatures_data_Osmosis_1h_signature_ISR_activated.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("Example_ISRsignatures_data_Osmosis_1h_signature_ISR.png")
...
knitr::include_graphics("Example_ISRsignatures_data_Osmosis_1h_signature_ISR.png")
...
image_read_pdf("ExampleSignatures_heatmap.pdf", density = 300) %>%
  image_resize("3000x") %>%
  image_write("ExampleSignatures_heatmap.png")
...
knitr::include_graphics("ExampleSignatures_heatmap.png")

...
```{r gettingStartedEnumerate, eval=TRUE, echo=TRUE, fig.width=10, fig.height=5, fig.cap="Comparisons of 5'UTR length and GC content between mRNAs belonging to regulated gene sets."}
...
plot_content <- grDevices::recordPlot()
...
**Note**: If you use `motifAnalysis()` in your work, please appropriately cite the memes R package, The MEME Suite, and the STREME tool. Licensing for The MEME Suite is free for non-profit use. However, for-profit users should contact [OIC-MEMESuite\@ucsd.edu](mailto:OIC-MEMESuite@ucsd.edu){.email} and purchase a license. See <http://meme-suite.org/doc/copyright.html> for details

...
motifs_utr5 <- motifAnalysis(ads = ads, annot = annot, regulation = 'translationUp', contrast = 1, region = 'UTR5', selection ='random',  tomtom_database =list.files(system.file("extdata/motifs/human",package = "anota2seqUtils")))
@

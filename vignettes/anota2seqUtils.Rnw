...
anota2seqUtilsRun(species='human',regionSel=c('UTR5','CDS','UTR3'), ads = ads2_pan4Ai, regulation = c("translationUp","translationDown"),
                  contrast = c(1,1), comparisons = list(c(1,2)),contentIn=list('G','C','A','T'),addSign=addSign, regulationGen='translation', contrastSel=1,
                  miRNATargetScanFile='Predicted_Targets_Context_Scores.txt',analysis_type='lm',memePath='/opt/local/bin/')
